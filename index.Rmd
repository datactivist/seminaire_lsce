---
title: "L'ouverture des données de la recherche"
...
---
class: center
# .red[L'ouverture des données de la recherche]
...
[.reduite.center[![](img/MaDada.jpg)]](https://madada.fr/demande/donnees_relatives_a_la_concentra)
...
[.pull-right[
![](img/PNSO.jpg)]](https://www.ouvrirlascience.fr/plan-national-pour-la-science-ouverte/)
...
## En pratique : que faire de mes données ?

[.reduite.center[![](img/Doranum.png)]](https://www.youtube.com/watch?v=P612sq45XxE)

Référentes données : Karine Pellerin <karine.pellerin@uvsq.fr> et Claire Lebreton <claire.lebreton@uvsq.fr>

???

A l'UVSQ, la BU est en train de formaliser un service aux chercheurs dédié aux données de la recherche, sur deux points :
1. appui à la rédaction de PGD dans le cadre des projets de recherche Europe & ANR
2. [formation/sensibilisation doctorale sur les données de la recherche](https://www.bib.uvsq.fr/science-ouverte-jeune-enseignant%c2%b7e-chercheur%c2%b7e-1) ; aussi via Paris Saclay un MOOC dédié aux Données de la rech. doit sortir d'ici fin 2021
